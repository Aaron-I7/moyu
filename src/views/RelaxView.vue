...
<template>
  <div class="page moyu-page">
    <div class="page-inner">
      ...
      <div v-if="relaxModules.length > 0" class="module-list">
        <div 
        ...
        >
          <div class="card-icon">
            <ModuleIcon :config="module" :size="40" />
          </div>
          <div class="card-content">
            <h3>{{ resolveModuleName(t, module) }}</h3>
            <p>{{ resolveModuleDescription(t, module) }}</p>
          </div>
          <div v-if="resolveModuleTags(t, module).length > 0" class="card-tags">
            <span v-for="tag in resolveModuleTags(t, module).slice(0, 3)" :key="tag" class="tag">
              {{ tag }}
            </span>
          </div>
        </div>
      ...
      <div v-else class="empty">
        ...
        <h3>{{ t('views.emptyRelax') }}</h3>
        <p>{{ t('views.emptyRelaxDesc') }}</p>
      </div>
    </div>
  </div>
</template>
